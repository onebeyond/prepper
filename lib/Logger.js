...
function Logger(_options) {
    ...
    var options = extend({ message: '', level: 'info', paused: false, maxListeners: 100 }, _options)
    var listeners = {}
    var children = []
    ...
    function logEvent(arg1, arg2, arg3, arg4) {
        ...
        if (arguments.length === 4) return self.emit('message', R.mergeAll([
        ...
        // message, error, level
        if (arguments.length === 3 && isString(arg1) && isError(arg2) && isString(arg3)) return logEvent(arg1, arg2, null, arg3)
        // message, error, context
        if (arguments.length === 3 && isString(arg1) && isError(arg2) && isObject(arg3)) return logEvent(arg1, arg2, arg3, null)
        // message, context, level
        if (arguments.length === 3 && isString(arg1) && isObject(arg2) && isString(arg3)) return logEvent(arg1, null, arg2, arg3)
        // error, context, level
        if (arguments.length === 3 && isError(arg1) && isObject(arg2) && isString(arg3)) return logEvent(null, arg1, arg2, arg3)
        // message, level
        if (arguments.length === 2 && isString(arg1) && isString(arg2)) return logEvent(arg1, null, null, arg2)
        // message, error
        if (arguments.length === 2 && isString(arg1) && isError(arg2)) return logEvent(arg1, arg2, null, null)
        // message, context
        if (arguments.length === 2 && isString(arg1) && isObject(arg2)) return logEvent(arg1, null, arg2, null)
        // error, level
        if (arguments.length === 2 && isError(arg1) && isString(arg2)) return logEvent(null, arg1, null, arg2)
        // error, context
        if (arguments.length === 2 && isError(arg1) && isObject(arg2)) return logEvent(null, arg1, arg2, null)
        // context, level
        if (arguments.length === 2 && isObject(arg1) && isString(arg2)) return logEvent(null, null, arg1, arg2)
        // message
        if (arguments.length === 1 && isString(arg1)) return logEvent(arg1, null, null, null)
        // error
        if (arguments.length === 1 && isError(arg1)) return logEvent(null, arg1, null, null)
        // context
        if (arguments.length === 1 && isObject(arg1)) return logEvent(null, null, arg1, null)
        // usage error
