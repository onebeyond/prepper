...
function Logger(_options) {
    ...
    self.trace = function trace(arg1, arg2, arg3) {
        self._logEvent.apply(self, toArray(arguments).concat('trace'))
        return self
    }

    self.debug = function debug(arg1, arg2, arg3) {
        self._logEvent.apply(self, toArray(arguments).concat('debug'))
        return self
    }

    self.info = function info(arg1, arg2, arg3) {
        self._logEvent.apply(self, toArray(arguments).concat('info'))
        return self
    }

    self.warn = function warn(arg1, arg2, arg3) {
        self._logEvent.apply(self, toArray(arguments).concat('warn'))
        return self
    }

    self.error = function error(arg1, arg2, arg3) {
        self._logEvent.apply(self, toArray(arguments).concat('error'))
        return self
    }

    self.fatal = function fatal(arg1, arg2, arg3) {
        self._logEvent.apply(self, toArray(arguments).concat('fatal'))
        return self
    }
